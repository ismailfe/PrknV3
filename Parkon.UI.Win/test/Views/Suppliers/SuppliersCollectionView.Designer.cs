namespace Emikon.Parkon.UI.Win.test.Views.SuppliersCollectionView {
    partial class SuppliersCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Suppliers";
			// 
            // gridControl
            // 
			...
			this.suppliersCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.suppliersCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Suppliers);
			this.gridControl.DataSource = suppliersCollectionViewBindingSource;
			...
			//Supplier_Type
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Supplier_TypePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Supplier_TypePopulateColumnParameters.FieldName = "Supplier_Type";
            Supplier_TypePopulateColumnParameters.Path = "Supplier_Type.Name";
			parameters.CustomColumnParameters.Add(Supplier_TypePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Supplier_TypePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Supplier_TypePopulateColumnParameters_NotGenerate.FieldName = "SupplierTypeId";
		    Supplier_TypePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Supplier_TypePopulateColumnParameters_NotGenerate);
									//
			//Users
			//
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Suppliers),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.SuppliersCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "SuppliersCollectionView";
		...
		private System.Windows.Forms.BindingSource suppliersCollectionViewBindingSource;
