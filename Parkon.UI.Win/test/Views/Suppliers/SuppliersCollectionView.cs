...
namespace Emikon.Parkon.UI.Win.test.Views.SuppliersCollectionView{
    public partial class SuppliersCollectionView : XtraUserControl {
        public SuppliersCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.SuppliersCollectionViewModel>();
