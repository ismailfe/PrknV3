...
namespace Emikon.Parkon.UI.Win.test.Views.ProjectsCollectionView{
    public partial class ProjectsCollectionView : XtraUserControl {
        public ProjectsCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.ProjectsCollectionViewModel>();
