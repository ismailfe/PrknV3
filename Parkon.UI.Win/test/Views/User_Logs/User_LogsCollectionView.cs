...
namespace Emikon.Parkon.UI.Win.test.Views.User_LogsCollectionView{
    public partial class User_LogsCollectionView : XtraUserControl {
        public User_LogsCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.User_LogsCollectionViewModel>();
