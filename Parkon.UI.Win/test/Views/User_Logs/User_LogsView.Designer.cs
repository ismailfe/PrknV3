namespace Emikon.Parkon.UI.Win.test.Views.User_LogsView {
    partial class User_LogsView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.user_LogsViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.user_LogsViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.User_Logs);
			this.dataLayoutControl1.DataSource = user_LogsViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", user_LogsViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.User_LogsViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "User_Logs - Element View";
		...
		private System.Windows.Forms.BindingSource user_LogsViewBindingSource;
