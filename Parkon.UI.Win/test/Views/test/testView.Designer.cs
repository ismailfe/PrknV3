namespace Emikon.Parkon.UI.Win.test.Views.testView {
    partial class testView {
		...
		private void InitializeComponent() {
			...
			this.testViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.test);
			this.dataLayoutControl1.DataSource = testViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.testViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "test - Element View";
