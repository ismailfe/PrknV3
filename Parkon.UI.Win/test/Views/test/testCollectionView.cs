...
namespace Emikon.Parkon.UI.Win.test.Views.testCollectionView{
    public partial class testCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.testCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as Emikon.Parkon.Model.test,
