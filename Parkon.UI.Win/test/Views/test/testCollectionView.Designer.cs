namespace Emikon.Parkon.UI.Win.test.Views.testCollectionView {
    partial class testCollectionView {
		...
		private void InitializeComponent() {
			...
			this.testCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.testCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.test);
			this.gridControl.DataSource = testCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.test),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.testCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource testCollectionViewBindingSource;
