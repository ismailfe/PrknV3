...
namespace Emikon.Parkon.UI.Win.test.Views.User_DepartmentCollectionView{
    public partial class User_DepartmentCollectionView : XtraUserControl {
        public User_DepartmentCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.User_DepartmentCollectionViewModel>();
