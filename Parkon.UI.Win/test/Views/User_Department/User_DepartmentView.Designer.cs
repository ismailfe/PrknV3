namespace Emikon.Parkon.UI.Win.test.Views.User_DepartmentView {
    partial class User_DepartmentView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.user_DepartmentViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.user_DepartmentViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.User_Department);
			this.dataLayoutControl1.DataSource = user_DepartmentViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", user_DepartmentViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.User_DepartmentViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "User_Department - Element View";
		...
		private System.Windows.Forms.BindingSource user_DepartmentViewBindingSource;
