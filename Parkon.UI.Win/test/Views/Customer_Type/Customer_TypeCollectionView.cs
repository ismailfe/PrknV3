...
namespace Emikon.Parkon.UI.Win.test.Views.Customer_TypeCollectionView{
    public partial class Customer_TypeCollectionView : XtraUserControl {
        public Customer_TypeCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Customer_TypeCollectionViewModel>();
