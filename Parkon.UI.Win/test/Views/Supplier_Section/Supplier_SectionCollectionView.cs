...
namespace Emikon.Parkon.UI.Win.test.Views.Supplier_SectionCollectionView{
    public partial class Supplier_SectionCollectionView : XtraUserControl {
        public Supplier_SectionCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Supplier_SectionCollectionViewModel>();
