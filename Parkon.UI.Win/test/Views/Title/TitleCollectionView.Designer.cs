namespace Emikon.Parkon.UI.Win.test.Views.TitleCollectionView {
    partial class TitleCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.titleCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.titleCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Title);
			this.gridControl.DataSource = titleCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Title),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.TitleCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource titleCollectionViewBindingSource;
