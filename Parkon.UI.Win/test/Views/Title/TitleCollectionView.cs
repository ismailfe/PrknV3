...
namespace Emikon.Parkon.UI.Win.test.Views.TitleCollectionView{
    public partial class TitleCollectionView : XtraUserControl {
        public TitleCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.TitleCollectionViewModel>();
