...
namespace Emikon.Parkon.UI.Win.test.Views.Store_AddressColCollectionView{
    public partial class Store_AddressColCollectionView : XtraUserControl {
        public Store_AddressColCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_AddressColCollectionViewModel>();
