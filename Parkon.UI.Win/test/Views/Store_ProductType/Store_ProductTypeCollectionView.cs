...
namespace Emikon.Parkon.UI.Win.test.Views.Store_ProductTypeCollectionView{
    public partial class Store_ProductTypeCollectionView : XtraUserControl {
        public Store_ProductTypeCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_ProductTypeCollectionViewModel>();
