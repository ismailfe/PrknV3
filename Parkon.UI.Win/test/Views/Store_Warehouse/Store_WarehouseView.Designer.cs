namespace Emikon.Parkon.UI.Win.test.Views.Store_WarehouseView {
    partial class Store_WarehouseView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.store_WarehouseViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.store_WarehouseViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Store_Warehouse);
			this.dataLayoutControl1.DataSource = store_WarehouseViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.Store_ProductLookUpEdit.DataBindings.Add("EditValue", store_WarehouseViewBindingSource, "ProductId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.Store_ProductBlockLookUpEdit.DataBindings.Add("EditValue", store_WarehouseViewBindingSource, "BlockId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", store_WarehouseViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Store_WarehouseViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Store_Warehouse - Element View";
		...
		private System.Windows.Forms.BindingSource store_WarehouseViewBindingSource;
