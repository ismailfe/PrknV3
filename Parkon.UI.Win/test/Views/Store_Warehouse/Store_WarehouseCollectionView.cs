...
namespace Emikon.Parkon.UI.Win.test.Views.Store_WarehouseCollectionView{
    public partial class Store_WarehouseCollectionView : XtraUserControl {
        public Store_WarehouseCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_WarehouseCollectionViewModel>();
