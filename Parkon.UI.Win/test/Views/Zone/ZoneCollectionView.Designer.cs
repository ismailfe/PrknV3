namespace Emikon.Parkon.UI.Win.test.Views.ZoneCollectionView {
    partial class ZoneCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.zoneCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.zoneCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Zone);
			this.gridControl.DataSource = zoneCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Zone),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.ZoneCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource zoneCollectionViewBindingSource;
