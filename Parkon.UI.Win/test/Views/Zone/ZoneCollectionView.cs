...
namespace Emikon.Parkon.UI.Win.test.Views.ZoneCollectionView{
    public partial class ZoneCollectionView : XtraUserControl {
        public ZoneCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.ZoneCollectionViewModel>();
