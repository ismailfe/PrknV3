namespace Emikon.Parkon.UI.Win.test.Views.Store_AddressCollectionView {
    partial class Store_AddressCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Store_Address";
			// 
            // gridControl
            // 
			...
			this.store_AddressCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.store_AddressCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Store_Address);
			this.gridControl.DataSource = store_AddressCollectionViewBindingSource;
			...
			//Store_AddressCol
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressColPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressColPopulateColumnParameters.FieldName = "Store_AddressCol";
            Store_AddressColPopulateColumnParameters.Path = "Store_AddressCol.Name";
			parameters.CustomColumnParameters.Add(Store_AddressColPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressColPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressColPopulateColumnParameters_NotGenerate.FieldName = "ColId";
		    Store_AddressColPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_AddressColPopulateColumnParameters_NotGenerate);
									//
			//Store_AddressPos
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressPosPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressPosPopulateColumnParameters.FieldName = "Store_AddressPos";
            Store_AddressPosPopulateColumnParameters.Path = "Store_AddressPos.Name";
			parameters.CustomColumnParameters.Add(Store_AddressPosPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressPosPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressPosPopulateColumnParameters_NotGenerate.FieldName = "PosId";
		    Store_AddressPosPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_AddressPosPopulateColumnParameters_NotGenerate);
									//
			//Store_AddressRow
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressRowPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressRowPopulateColumnParameters.FieldName = "Store_AddressRow";
            Store_AddressRowPopulateColumnParameters.Path = "Store_AddressRow.Name";
			parameters.CustomColumnParameters.Add(Store_AddressRowPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressRowPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressRowPopulateColumnParameters_NotGenerate.FieldName = "RowId";
		    Store_AddressRowPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_AddressRowPopulateColumnParameters_NotGenerate);
									//
			//Store_AddressZone
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressZonePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressZonePopulateColumnParameters.FieldName = "Store_AddressZone";
            Store_AddressZonePopulateColumnParameters.Path = "Store_AddressZone.Name";
			parameters.CustomColumnParameters.Add(Store_AddressZonePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_AddressZonePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_AddressZonePopulateColumnParameters_NotGenerate.FieldName = "ZoneId";
		    Store_AddressZonePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_AddressZonePopulateColumnParameters_NotGenerate);
									//
			//Users
			//
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Store_Address),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Store_AddressCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "Store_AddressCollectionView";
		...
		private System.Windows.Forms.BindingSource store_AddressCollectionViewBindingSource;
