...
namespace Emikon.Parkon.UI.Win.test.Views.Customer_SectionCollectionView{
    public partial class Customer_SectionCollectionView : XtraUserControl {
        public Customer_SectionCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Customer_SectionCollectionViewModel>();
