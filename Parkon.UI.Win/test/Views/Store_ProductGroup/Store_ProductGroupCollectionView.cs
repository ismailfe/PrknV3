...
namespace Emikon.Parkon.UI.Win.test.Views.Store_ProductGroupCollectionView{
    public partial class Store_ProductGroupCollectionView : XtraUserControl {
        public Store_ProductGroupCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_ProductGroupCollectionViewModel>();
