...
namespace Emikon.Parkon.UI.Win.test.Views.Project_DetailCollectionView{
    public partial class Project_DetailCollectionView : XtraUserControl {
        public Project_DetailCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Project_DetailCollectionViewModel>();
