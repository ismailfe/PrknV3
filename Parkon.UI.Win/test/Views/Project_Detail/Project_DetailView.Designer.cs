namespace Emikon.Parkon.UI.Win.test.Views.Project_DetailView {
    partial class Project_DetailView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.project_DetailViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.project_DetailViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Project_Detail);
			this.dataLayoutControl1.DataSource = project_DetailViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters UsersProjectsChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            UsersProjectsChildPopulateColumnParameters.FieldName = "UsersProjects";
            UsersProjectsChildPopulateColumnParameters.Path = "Users.NameFirst";
			ProjectsPopulateColumnsParameters.CustomColumnParameters.Add(UsersProjectsChildPopulateColumnParameters);
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", project_DetailViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Project_DetailViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Project_Detail - Element View";
		...
		private System.Windows.Forms.BindingSource project_DetailViewBindingSource;
