...
namespace Emikon.Parkon.UI.Win.test.Views.Store_LocationCollectionView{
    public partial class Store_LocationCollectionView : XtraUserControl {
        public Store_LocationCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_LocationCollectionViewModel>();
