namespace Emikon.Parkon.UI.Win.test.Views.Store_LocationView {
    partial class Store_LocationView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.store_LocationViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.store_LocationViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Store_Location);
			this.dataLayoutControl1.DataSource = store_LocationViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", store_LocationViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Store_LocationViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Store_Location - Element View";
		...
		private System.Windows.Forms.BindingSource store_LocationViewBindingSource;
