...
namespace Emikon.Parkon.UI.Win.test.Views.Supplier_TypeCollectionView{
    public partial class Supplier_TypeCollectionView : XtraUserControl {
        public Supplier_TypeCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Supplier_TypeCollectionViewModel>();
