...
namespace Emikon.Parkon.UI.Win.test.Views.Store_OutActionCollectionView{
    public partial class Store_OutActionCollectionView : XtraUserControl {
        public Store_OutActionCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_OutActionCollectionViewModel>();
