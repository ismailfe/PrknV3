...
namespace Emikon.Parkon.UI.Win.test.Views.Store_ProductUnitCollectionView{
    public partial class Store_ProductUnitCollectionView : XtraUserControl {
        public Store_ProductUnitCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_ProductUnitCollectionViewModel>();
