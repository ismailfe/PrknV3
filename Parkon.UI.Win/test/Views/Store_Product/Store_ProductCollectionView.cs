...
namespace Emikon.Parkon.UI.Win.test.Views.Store_ProductCollectionView{
    public partial class Store_ProductCollectionView : XtraUserControl {
        public Store_ProductCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_ProductCollectionViewModel>();
