namespace Emikon.Parkon.UI.Win.test.Views.CustomersCollectionView {
    partial class CustomersCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.customersCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.customersCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Customers);
			this.gridControl.DataSource = customersCollectionViewBindingSource;
			...
			//Customer_Type
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customer_TypePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customer_TypePopulateColumnParameters.FieldName = "Customer_Type";
            Customer_TypePopulateColumnParameters.Path = "Customer_Type.Name";
			parameters.CustomColumnParameters.Add(Customer_TypePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customer_TypePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customer_TypePopulateColumnParameters_NotGenerate.FieldName = "CustomerTypeId";
		    Customer_TypePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Customer_TypePopulateColumnParameters_NotGenerate);
									//
			//Customers1
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customers1PopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customers1PopulateColumnParameters.FieldName = "Customers1";
            Customers1PopulateColumnParameters.Path = "Customers1.Name";
			parameters.CustomColumnParameters.Add(Customers1PopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customers1PopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customers1PopulateColumnParameters_NotGenerate.FieldName = "Id";
		    Customers1PopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Customers1PopulateColumnParameters_NotGenerate);
									//
			//Customers2
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customers2PopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customers2PopulateColumnParameters.FieldName = "Customers2";
            Customers2PopulateColumnParameters.Path = "Customers2.Name";
			parameters.CustomColumnParameters.Add(Customers2PopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customers2PopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customers2PopulateColumnParameters_NotGenerate.FieldName = "Id";
		    Customers2PopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Customers2PopulateColumnParameters_NotGenerate);
									//
			//Users
			//
			...
			//Zone
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ZonePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ZonePopulateColumnParameters.FieldName = "Zone";
            ZonePopulateColumnParameters.Path = "Zone.Name";
			parameters.CustomColumnParameters.Add(ZonePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters ZonePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ZonePopulateColumnParameters_NotGenerate.FieldName = "ZoneId";
		    ZonePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ZonePopulateColumnParameters_NotGenerate);
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customers1PopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customers1PopulateColumnParameters_NotVisible.FieldName = "Customers1";
		    Customers1PopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Customers1PopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Customers2PopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Customers2PopulateColumnParameters_NotVisible.FieldName = "Customers2";
		    Customers2PopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Customers2PopulateColumnParameters_NotVisible);
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Customers),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.CustomersCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "CustomersCollectionView";
		...
		private System.Windows.Forms.BindingSource customersCollectionViewBindingSource;
