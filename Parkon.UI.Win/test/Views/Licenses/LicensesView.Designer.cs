namespace Emikon.Parkon.UI.Win.test.Views.LicensesView {
    partial class LicensesView {
		...
		private void InitializeComponent() {
			...
			this.licensesViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.licensesViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Licenses);
			this.dataLayoutControl1.DataSource = licensesViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", licensesViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.LicensesViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Licenses - Element View";
		...
		private System.Windows.Forms.BindingSource licensesViewBindingSource;
