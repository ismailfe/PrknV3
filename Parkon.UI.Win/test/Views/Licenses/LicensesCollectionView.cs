...
namespace Emikon.Parkon.UI.Win.test.Views.LicensesCollectionView{
    public partial class LicensesCollectionView : XtraUserControl {
        public LicensesCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.LicensesCollectionViewModel>();
