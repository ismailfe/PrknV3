namespace Emikon.Parkon.UI.Win.test.Views.KeywordView {
    partial class KeywordView {
		...
		private void InitializeComponent() {
			...
			this.keywordViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.keywordViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Keyword);
			this.dataLayoutControl1.DataSource = keywordViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", keywordViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.KeywordViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Keyword - Element View";
		...
		private System.Windows.Forms.BindingSource keywordViewBindingSource;
