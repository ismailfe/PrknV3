...
namespace Emikon.Parkon.UI.Win.test.Views.KeywordCollectionView{
    public partial class KeywordCollectionView : XtraUserControl {
        public KeywordCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.KeywordCollectionViewModel>();
