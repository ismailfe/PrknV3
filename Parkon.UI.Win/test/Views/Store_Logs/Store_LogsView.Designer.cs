namespace Emikon.Parkon.UI.Win.test.Views.Store_LogsView {
    partial class Store_LogsView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.store_LogsViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.store_LogsViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Store_Logs);
			this.dataLayoutControl1.DataSource = store_LogsViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", store_LogsViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Store_LogsViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Store_Logs - Element View";
		...
		private System.Windows.Forms.BindingSource store_LogsViewBindingSource;
