...
namespace Emikon.Parkon.UI.Win.test.Views.Store_LogsCollectionView{
    public partial class Store_LogsCollectionView : XtraUserControl {
        public Store_LogsCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_LogsCollectionViewModel>();
