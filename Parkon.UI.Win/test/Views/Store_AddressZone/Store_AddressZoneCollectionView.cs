...
namespace Emikon.Parkon.UI.Win.test.Views.Store_AddressZoneCollectionView{
    public partial class Store_AddressZoneCollectionView : XtraUserControl {
        public Store_AddressZoneCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_AddressZoneCollectionViewModel>();
