...
namespace Emikon.Parkon.UI.Win.test.Views.Customer_ContactCollectionView{
    public partial class Customer_ContactCollectionView : XtraUserControl {
        public Customer_ContactCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Customer_ContactCollectionViewModel>();
