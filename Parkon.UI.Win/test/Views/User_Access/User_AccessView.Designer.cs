namespace Emikon.Parkon.UI.Win.test.Views.User_AccessView {
    partial class User_AccessView {
		...
		private void InitializeComponent() {
			...
			this.user_AccessViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.user_AccessViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.User_Access);
			this.dataLayoutControl1.DataSource = user_AccessViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", user_AccessViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.Users1LookUpEdit.DataBindings.Add("EditValue", user_AccessViewBindingSource, "SetUserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.User_AccessViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "User_Access - Element View";
		...
		private System.Windows.Forms.BindingSource user_AccessViewBindingSource;
