...
namespace Emikon.Parkon.UI.Win.test.Views.User_AccessCollectionView{
    public partial class User_AccessCollectionView : XtraUserControl {
        public User_AccessCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.User_AccessCollectionViewModel>();
