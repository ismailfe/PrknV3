namespace Emikon.Parkon.UI.Win.test.Views.Project_RevCollectionView {
    partial class Project_RevCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Project_Rev";
			// 
            // gridControl
            // 
			...
			this.project_RevCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.project_RevCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Project_Rev);
			this.gridControl.DataSource = project_RevCollectionViewBindingSource;
			...
			//Projects
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ProjectsPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ProjectsPopulateColumnParameters.FieldName = "Projects";
            ProjectsPopulateColumnParameters.Path = "Projects.Name";
			parameters.CustomColumnParameters.Add(ProjectsPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters ProjectsPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ProjectsPopulateColumnParameters_NotGenerate.FieldName = "ProjectId";
		    ProjectsPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ProjectsPopulateColumnParameters_NotGenerate);
									//
			//Users
			//
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Project_Rev),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Project_RevCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "Project_RevCollectionView";
		...
		private System.Windows.Forms.BindingSource project_RevCollectionViewBindingSource;
