...
namespace Emikon.Parkon.UI.Win.test.Views.Project_RevCollectionView{
    public partial class Project_RevCollectionView : XtraUserControl {
        public Project_RevCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Project_RevCollectionViewModel>();
