namespace Emikon.Parkon.UI.Win.test.Views.User_OnlineView {
    partial class User_OnlineView {
		...
		private void InitializeComponent() {
			...
			this.user_OnlineViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.user_OnlineViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.User_Online);
			this.dataLayoutControl1.DataSource = user_OnlineViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", user_OnlineViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.User_OnlineViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "User_Online - Element View";
		...
		private System.Windows.Forms.BindingSource user_OnlineViewBindingSource;
