...
namespace Emikon.Parkon.UI.Win.test.Views.User_OnlineCollectionView{
    public partial class User_OnlineCollectionView : XtraUserControl {
        public User_OnlineCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.User_OnlineCollectionViewModel>();
