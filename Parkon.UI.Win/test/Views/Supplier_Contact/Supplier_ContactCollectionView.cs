...
namespace Emikon.Parkon.UI.Win.test.Views.Supplier_ContactCollectionView{
    public partial class Supplier_ContactCollectionView : XtraUserControl {
        public Supplier_ContactCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Supplier_ContactCollectionViewModel>();
