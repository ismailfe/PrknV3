...
namespace Emikon.Parkon.UI.Win.test.Views.Supplier_ContactView{
    public partial class Supplier_ContactView : XtraUserControl {
        public Supplier_ContactView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
				InitBindings();
		}
		void InitBindings() {
		    var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Supplier_ContactViewModel>();
			fluentAPI.WithEvent(this, "Load").EventToCommand(x => x.OnLoaded());
            fluentAPI.SetObjectDataSourceBinding(
                supplier_ContactViewBindingSource, x => x.Entity, x => x.Update());
