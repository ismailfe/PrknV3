namespace Emikon.Parkon.UI.Win.test.Views.Supplier_ContactView {
    partial class Supplier_ContactView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.SuppliersBindingSource = new System.Windows.Forms.BindingSource(this.components);
						this.TitleLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			...
			this.supplier_ContactViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.supplier_ContactViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Supplier_Contact);
			this.dataLayoutControl1.DataSource = supplier_ContactViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.SuppliersLookUpEdit.DataBindings.Add("EditValue", supplier_ContactViewBindingSource, "SupplierId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			//TitleLookUpEdit
			//
			this.TitleBindingSource.DataSource = typeof(Emikon.Parkon.Model.Title);
			this.TitleLookUpEdit.Properties.ValueMember = "Id"; 
			this.TitleLookUpEdit.Properties.DisplayMember = "Name";
			this.TitleLookUpEdit.Properties.DataSource = this.TitleBindingSource;
			this.TitleLookUpEdit.Name = "TitleLookUpEdit";
			this.TitleLookUpEdit.DataBindings.Add("EditValue", supplier_ContactViewBindingSource, "TitleId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters TitleLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            TitleLookUpEditRetrieveFieldParameters.FieldName = "TitleId";
            TitleLookUpEditRetrieveFieldParameters.ControlForField = this.TitleLookUpEdit;
			parameters.CustomListParameters.Add(TitleLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters TitleLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    TitleLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "Title";
		    TitleLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(TitleLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//UsersLookUpEdit
			//
			...
			this.UsersLookUpEdit.DataBindings.Add("EditValue", supplier_ContactViewBindingSource, "UserId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Supplier_ContactViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Supplier_Contact - Element View";
            ...
            this.Name = "Supplier_ContactView";
		...
		private System.Windows.Forms.BindingSource supplier_ContactViewBindingSource;
						private DevExpress.XtraEditors.GridLookUpEdit SuppliersLookUpEdit;
		private System.Windows.Forms.BindingSource SuppliersBindingSource;
				private DevExpress.XtraEditors.GridLookUpEdit TitleLookUpEdit;
