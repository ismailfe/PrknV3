namespace Emikon.Parkon.UI.Win.test.Views.Supplier_ContactCollectionView {
    partial class Supplier_ContactCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Supplier_Contact";
			// 
            // gridControl
            // 
			...
			this.supplier_ContactCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.supplier_ContactCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Supplier_Contact);
			this.gridControl.DataSource = supplier_ContactCollectionViewBindingSource;
			...
			//Suppliers
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters SuppliersPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            SuppliersPopulateColumnParameters.FieldName = "Suppliers";
            SuppliersPopulateColumnParameters.Path = "Suppliers.Name";
			parameters.CustomColumnParameters.Add(SuppliersPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters SuppliersPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            SuppliersPopulateColumnParameters_NotGenerate.FieldName = "SupplierId";
		    SuppliersPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(SuppliersPopulateColumnParameters_NotGenerate);
									//
			//Title
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters TitlePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            TitlePopulateColumnParameters.FieldName = "Title";
            TitlePopulateColumnParameters.Path = "Title.Name";
			parameters.CustomColumnParameters.Add(TitlePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters TitlePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            TitlePopulateColumnParameters_NotGenerate.FieldName = "TitleId";
		    TitlePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(TitlePopulateColumnParameters_NotGenerate);
									//
			//Users
			//
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Supplier_Contact),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Supplier_ContactCollectionViewModel);
			// 
            // layoutControl
            // 
			...
			//
			//Supplier_ContactCollectionView
			//
            ...
            this.Name = "Supplier_ContactCollectionView";
		...
		private System.Windows.Forms.BindingSource supplier_ContactCollectionViewBindingSource;
