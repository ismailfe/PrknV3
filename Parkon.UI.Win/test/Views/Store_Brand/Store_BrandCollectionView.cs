...
namespace Emikon.Parkon.UI.Win.test.Views.Store_BrandCollectionView{
    public partial class Store_BrandCollectionView : XtraUserControl {
        public Store_BrandCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_BrandCollectionViewModel>();
