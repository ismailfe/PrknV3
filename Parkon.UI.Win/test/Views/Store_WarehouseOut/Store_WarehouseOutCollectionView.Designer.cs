namespace Emikon.Parkon.UI.Win.test.Views.Store_WarehouseOutCollectionView {
    partial class Store_WarehouseOutCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Store_WarehouseOut";
			// 
            // gridControl
            // 
			...
			this.store_WarehouseOutCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.store_WarehouseOutCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.Store_WarehouseOut);
			this.gridControl.DataSource = store_WarehouseOutCollectionViewBindingSource;
			...
			//Store_Product
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_ProductPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_ProductPopulateColumnParameters.FieldName = "Store_Product";
            Store_ProductPopulateColumnParameters.Path = "Store_Product.Name";
			parameters.CustomColumnParameters.Add(Store_ProductPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_ProductPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_ProductPopulateColumnParameters_NotGenerate.FieldName = "ProductId";
		    Store_ProductPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_ProductPopulateColumnParameters_NotGenerate);
									//
			//Store_ProductBlock
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_ProductBlockPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_ProductBlockPopulateColumnParameters.FieldName = "Store_ProductBlock";
            Store_ProductBlockPopulateColumnParameters.Path = "Store_ProductBlock.SysCode";
			parameters.CustomColumnParameters.Add(Store_ProductBlockPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_ProductBlockPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_ProductBlockPopulateColumnParameters_NotGenerate.FieldName = "BlockId";
		    Store_ProductBlockPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_ProductBlockPopulateColumnParameters_NotGenerate);
									//
			//Users
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Store_ProductBlockPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Store_ProductBlockPopulateColumnParameters_NotVisible.FieldName = "Store_ProductBlock";
		    Store_ProductBlockPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Store_ProductBlockPopulateColumnParameters_NotVisible);
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.Store_WarehouseOut),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.Store_WarehouseOutCollectionViewModel);
			// 
            // layoutControl
            // 
			...
			//
			//Store_WarehouseOutCollectionView
			//
            ...
            this.Name = "Store_WarehouseOutCollectionView";
		...
		private System.Windows.Forms.BindingSource store_WarehouseOutCollectionViewBindingSource;
