...
namespace Emikon.Parkon.UI.Win.test.Views.User_AuthorizationCollectionView{
    public partial class User_AuthorizationCollectionView : XtraUserControl {
        public User_AuthorizationCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.User_AuthorizationCollectionViewModel>();
