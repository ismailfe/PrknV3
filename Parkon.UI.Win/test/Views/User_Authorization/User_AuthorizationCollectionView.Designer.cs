namespace Emikon.Parkon.UI.Win.test.Views.User_AuthorizationCollectionView {
    partial class User_AuthorizationCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "User_Authorization";
			// 
            // gridControl
            // 
			...
			this.user_AuthorizationCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.user_AuthorizationCollectionViewBindingSource.DataSource = typeof(Emikon.Parkon.Model.User_Authorization);
			this.gridControl.DataSource = user_AuthorizationCollectionViewBindingSource;
			...
			//Users1
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Users1PopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Users1PopulateColumnParameters.FieldName = "Users1";
            Users1PopulateColumnParameters.Path = "Users1.NameFirst";
			parameters.CustomColumnParameters.Add(Users1PopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Users1PopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Users1PopulateColumnParameters_NotGenerate.FieldName = "SetUserId";
		    Users1PopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Users1PopulateColumnParameters_NotGenerate);
			...
			this.gridView.PopulateColumns(typeof(Emikon.Parkon.Model.User_Authorization),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(Emikon.Parkon.UI.Win.test.ViewModels.User_AuthorizationCollectionViewModel);
			// 
            // layoutControl
            // 
			...
			//
			//User_AuthorizationCollectionView
			//
            ...
            this.Name = "User_AuthorizationCollectionView";
		...
		private System.Windows.Forms.BindingSource user_AuthorizationCollectionViewBindingSource;
