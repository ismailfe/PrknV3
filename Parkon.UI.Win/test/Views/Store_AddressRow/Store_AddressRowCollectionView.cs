...
namespace Emikon.Parkon.UI.Win.test.Views.Store_AddressRowCollectionView{
    public partial class Store_AddressRowCollectionView : XtraUserControl {
        public Store_AddressRowCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_AddressRowCollectionViewModel>();
