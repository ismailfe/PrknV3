...
namespace Emikon.Parkon.UI.Win.test.Views.Store_AddressPosCollectionView{
    public partial class Store_AddressPosCollectionView : XtraUserControl {
        public Store_AddressPosCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<Emikon.Parkon.UI.Win.test.ViewModels.Store_AddressPosCollectionViewModel>();
