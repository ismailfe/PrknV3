...
//                        UserSystemLogsBll. .Save("DirectoryOrganizer", "CreateFolderRev", Str_OncekiRevNo, "OK", null, "Rev No bulundu.");
//                        goto case 1;
//                    case 1:
...
//                                        CopKlasoru_Yolu;
//                        LogFunctions.Save("DirectoryOrganizer", "CreateFolderRev-Case1", logNewVal, "OK", null, "Gerekli Vars / paths oluşturuldu.");
//                        goto case 2;
//                    case 2:
...
//                            LogFunctions.Save("DirectoryOrganizer", "CreateFolderRev-Case2", sts.ToString(), "OK", null, "Yeni Rev klasörü oluşturuldu.");
//                        }
...
//                        LogFunctions.Save("DirectoryOrganizer", "CreateFolderRev-Case3", logNewVal2, "OK", null, "Arşivleme işlemi tamamlandı.");
//                        goto case 4;
//                    case 4:
...
//                        LogFunctions.Save("DirectoryOrganizer", "CreateFolderRev-Case4", logNewVal3, "OK", null, "Önceki Rev klasörü silindi.");
...
//                        LogFunctions.Save("DirectoryOrganizer", "CreateFolderRev-Case6", logNewVal4, "OK", null, "Önceki Rev arşivi Rev klasörüne taşındı.");
...
//                        LogFunctions.Save("DirectoryOrganizer", "CreateFolderRev-Case8", logNewVal5, "OK", null, "Yeni Prroje info Txt oluşturuldu. Arşivleme tamamlandı.");
//                        status = "Arşivleme işlemi tamamlandı";
//                        goto case 50;
//                    case 50:
//                        break;
...
//                LogFunctions.Save("DirectoryOrganizer", "CreateDirectory", sts.ToString(), "OK");

//                return true;
//            }
//            else
//            {
//                LogFunctions.Save("DirectoryOrganizer", "CreateDirectory", path, "WARNING", null, "Dizin Mevcut");
//                return false;
//            }
//        }
